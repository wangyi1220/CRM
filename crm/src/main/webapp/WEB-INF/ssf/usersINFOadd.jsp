            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal" action="../SysUsersInfoCtrl/add.do" target="_self" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control"  name="empSex">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
