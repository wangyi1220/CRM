         ...
         <div class="ibox-content">
             <form class="form-horizontal m-t" id="commentForm" action="SysUsersInfoCtrl/add.do" method="post" target="_self" enctype="multipart/form-data" onsubmit="return checksize()">                 
                   <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input id="empName" name="empName" class="form-control" type="text" required>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">公司编号：</label>
                         <div class="col-sm-8">
                         <select name="companyId"  style="width: 1065.83px;height: 34px;border-radius: 5px;outline: none;">
