            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal" action="../SyDeptCtrl/update.do" target="_self">
                            
                            <div class="form-group">
                                <label class="col-sm-2 control-label">部门编号</label>

                                <div class="col-sm-10">
                                    <input type="text" class="form-control" value="${u.deptId }" name="deptId">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" value=${u.deptName } name="deptName">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" value=${u.beizhu } name="beizhu">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" value=${u.companyId } name="companyId">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
