                        ...
                        <div class="ibox-content">
                            ...
                            <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="8">
                                ...
                                <tr>
                                    ...
                                    <td>
                                     <button class="btn btn-outline btn-info  dim" data-toggle="modal" data-target="#${info.deptId}"  data-placement="bottom" title="编辑">
                                     <i class="fa fa-paste"></i>
                                    </button>
                                    
                                <div class="modal inmodal fade" id="${info.deptId}" tabindex="-1" role="dialog"  aria-hidden="true">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form action="SysPostCtrl/update.do" method="post" target="_self" enctype="multipart/form-data">
                                         <div class="modal-body">
                                              ...
                                              &emsp;&emsp;&emsp;&emsp;<span>部门编号：<input type="text" name="deptId"  value="${info.deptId}"></span>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</span>
                                              </div>
                                              <div>
                                              &emsp;&emsp;&emsp;&emsp;<span>部门名称：<input type="text" name="deptName"  value="${info.deptName}"></span>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</span>
                                              </div>
                                              <div>
                            ...
                            <td>
                                ...
                                <tr>
                                    ...
                                    <a target="_self" href="SyDeptCtrl/listPage.do?pageNum=${p.firstPage }">首页</a>
                                    <a target="_self" href="SyDeptCtrl/listPage.do?pageNum=${p.prePage }">上一页</a>
                                    <a target="_self" href="SyDeptCtrl/listPage.do?pageNum=${p.nextPage }">下一页</a>
                                    <a target="_self" href="SyDeptCtrl/listPage.do?pageNum=${p.lastPage }">尾页</a>
