            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal" action="addSINFO.do" target="_self">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                	<!-- /*？=name的属性名字有要求吗 -->
                                    <input type="text" class="form-control" placeholder="请输入销售单编号" name="sorderId">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">                                	
                                    <input type="text" class="form-control" placeholder="请输入商品编号" name="goodsId">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" placeholder="请输入商品数量" name="goodsQuantity">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" placeholder="请输入商品价格" name="goodsPrice">
                                </div>
                            </div>
