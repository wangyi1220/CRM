                    ...
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal" action="../KCCKControllerCtrl/update.do" target="_self">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" value="${kcck.cangkuName}" name="cangkuName">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" value="${kcck.cangkuNote}" name="cangkuNote">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" value="${kcck.companyId}" name="companyId">
                                </div>
                            </div>
