...
<body class="gray-bg">
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal" action="../KCCKControllerCtrl/add.do" target="_self">
                            
                            <div class="form-group">
                                <label class="col-sm-2 control-label">仓库名称</label>

                                <div class="col-sm-10">
                                    <input type="text" class="form-control" placeholder="请输入仓库名称" name="cangkuName">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" placeholder="请输入备注信息" name="cangkuNote">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
    ...
    <script>
    	...
    	if(${issuc=='yes'}){
        		swal({title:"添加仓库信息",text:"添加仓库信息成功",type:"success"})
        	}
    </script>
